...
const { state, saveCreds } = await useMultiFileAuthState('fixsession');
...
return {
conversation: 'WhatsApp Bot By FiX'
}}})
...
startingBot()
} else if (reason === DisconnectReason.badfixsession) {
...
if (connection == 'open') {
Sky.sendMessage(Sky.user.id.split(":")[0] + "@s.whatsapp.net", {text: `${`*FiX BOT 1.0.0*

Don't forget to follow to the Channel developer -> https://whatsapp.com/channel/0029Vb5K339KWEKvcYNZKr16 so you can get the latest updates about this script :)`.toString()}`})
console.log(chalk.blue.bold(`FiX BOT Connected ✓\n\n`))
randomToken(Sky)
